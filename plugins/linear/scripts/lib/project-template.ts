 ...
 * 6. Post-execution verification
 */
export async function createProject(teamId: string, config: ProjectConfig): Promise<CreateResult> {
  ...
  issues: [
    {
      ...
      console.log(
        '  import { createProject, createProjectWithDefaults } from "./lib/project-template"',
      );
      console.log('');
      console.log('Environment:');
      console.log(
        '  LINEAR_DEFAULT_INITIATIVE_ID - Default initiative ID for createProjectWithDefaults()',
      );
    }
  }
