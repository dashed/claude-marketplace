...
| **obsidian-bases** | Create and edit Obsidian Bases (`.base` files) — the YAML format that turns notes into database-like table/cards/list/map views with filters, computed formulas, and summary aggregations. Use when working with `.base` files, building database-like views of notes, or when the user mentions Bases, table/card views, filters, or formulas in Obsidian. Ported verbatim from kepano's obsidian-skills; includes a complete per-type functions reference. | [kepano](https://github.com/kepano/obsidian-skills/tree/main/skills/obsidian-bases) | [kepano](https://github.com/kepano/obsidian-skills/tree/main/skills/obsidian-markdown) |
