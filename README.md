...
| **jev** | Consult Jev for typed second opinions on plans, evidence, and priorities; configurable providers, optional without a key | [dashed](https://github.com/dashed/claude-marketplace/tree/master/plugins/jev) |
| **python-complexity** | Python complexity per function and call path, with optional Jev semantic review through configurable providers (Vercel by default), skipped without a key | [dashed](https://github.com/dashed/claude-marketplace/tree/master/plugins/python-complexity) |
