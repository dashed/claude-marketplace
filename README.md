...
| **comment-slop** | Remove redundant comments and docstring clauses while preserving rationale, contracts, and docs/tooling consumers; optional Jev review of candidates and proposed reductions | [dashed](https://github.com/dashed/claude-marketplace/tree/master/plugins/comment-slop) |
| **doc-quality** | Review engineering Markdown by section; static readability, preservation, and local link checks plus optional Jev judgments for designs, analyses, plans, and ADRs | [dashed](https://github.com/dashed/claude-marketplace/tree/master/plugins/doc-quality) |
